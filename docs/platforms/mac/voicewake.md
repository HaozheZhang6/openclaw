...
Voice Wake and push-to-talk require macOS 26 or newer. The macOS app can still run
on older supported macOS versions, but the Voice settings page hides the
Voice Wake controls and shows a "Not supported on this macOS version" message.
